...
var fashion = [
{
  ...
  categories: 'earrings',
  price: '$19.99',
  description: 'The right earrings can make you look all the prettier any day of the week! These silver plated drop earrings with a pearl setting, bring a hint of luxury to your outfit and draw attention with every turn of your head.'
},
...

{
  ...
  categories: 'Bags',
  price: '$59.99',
  description: 'High quality fabric, you will feel smooth and comfortable. Strong bearing through bar tacking.Thick sponge shoulder strap. Good quality mesh bag and buckles. Fine workmanship.'
},
...
function allFashion(){
  ...
  document.getElementById('view').innerHTML
   ...
   + '<br><p class="text-light"> ' + fashion[i].style + '</p>'
   + '<br><p class="text-light"> ' + fashion[i].price + '</p>'
   + '</div>';
   }
 };
...
$("#about").click(function(){
  $(".dropdown").hide();
  document.getElementById('alert').innerHTML = "About us";
});

$("#jewellery").click(function(){
  document.getElementById('alert').innerHTML = "Just For You";
});
...
document.getElementById('view').innerHTML = " "; //to clear the container
document.getElementById('view').innerHTML +=
'<img class="w-100 mb-5" src="images/aboutBanner.jpg" alt="...">'
+'<p class="text-light mb-5">Kia Ora !<br>Vandy is basically New Zealand based store for women\'s accessories collection. Initially we are only trading with women\'s Jewellery and bags collection but in near future looking for bringing lot more for you women..<br><br> Happy spring !  Happy shopping !</p>'
});
...
$('.test1').on('click', function(){
  ...
  for(var i = 0; i < fashion.length; i++) {
    if (fashion[i].style === 'Drop Earrings') {
      document.getElementById('view').innerHTML
       +='<div class="col col-sm-6 col-md-6 col-lg-3 ml-md-5 mx-auto">'
